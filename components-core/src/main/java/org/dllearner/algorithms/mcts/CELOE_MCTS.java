...
@ComponentAnn(name="CELOE_MCTS", shortName="celoe_mcts", version=1.0, description="CELOE is an adapted and extended version of the OCEL algorithm applied for the ontology engineering use case. See http://jens-lehmann.org/files/2011/celoe.pdf for reference.")
public class CELOE_MCTS extends AbstractCELA implements Cloneable{

	private static final Logger logger = LoggerFactory.getLogger(CELOE_MCTS.class);
...
//	private OEHeuristicRuntime heuristicRuntime = new OEHeuristicRuntime();
	...
	private int timesCeloeDecided = 0;
	private int timesCeloeUndecided = 0;
	...
	public CELOE_MCTS(CELOE_MCTS celoe){
	...
	public CELOE_MCTS(AbstractClassExpressionLearningProblem problem, AbstractReasonerComponent reasoner) {
	...
	public void start() {
		...
		System.out.println("Times CELOE undecided: " + timesCeloeUndecided);
		System.out.println("Times CELOE decided: " + timesCeloeDecided);
		System.out.println("% CELOE undecided: "+ ((double)timesCeloeUndecided)/((double)timesCeloeUndecided+timesCeloeDecided));
