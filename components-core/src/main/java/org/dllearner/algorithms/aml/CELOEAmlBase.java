 ...
 * 
 * This is a duplication of the original CELOE for easier extension of AML
 *
 */
@SuppressWarnings("CloneDoesntCallSuperClone")
@ComponentAnn(name="CELOEAmlBase", shortName="celoe_aml_base", version=1.0, description="CELOE is an adapted and extended version of the OCEL algorithm applied for the ontology engineering use case. See http://jens-lehmann.org/files/2011/celoe.pdf for reference.")
public abstract class CELOEAmlBase extends AbstractCELA implements Cloneable{

	private static final Logger logger = LoggerFactory.getLogger(CELOEAmlBase.class);
	protected static final Marker sparql_debug = MarkerFactory.getMarker("SD");
	
	protected boolean isRunning = false;
	protected boolean stop = false;
	
//	protected OEHeuristicStable heuristicStable = new OEHeuristicStable();
//	protected OEHeuristicRuntime heuristicRuntime = new OEHeuristicRuntime();
	...
	protected int searchTreeDepth = 0;
	...
	public CELOEAmlBase(CELOEAmlBase celoe){
	...
	public CELOEAmlBase(AbstractClassExpressionLearningProblem problem, AbstractReasonerComponent reasoner) {
...
//							System.out.println("candidates: " + startClassCandidates);
	...
	protected OENode getNextNodeToExpand() {
...
//			System.out.println(bestEvaluatedDescriptions.getSet().size());
	...
	protected boolean isDescriptionAllowed(OWLClassExpression description, OENode parentNode) {
		if(isClassLearningProblem) {
			if(isEquivalenceProblem) {
...
//			}
	...
	protected void updateMinMaxHorizExp(OENode node) {
