...
public class OEHeuristicRuntime extends AbstractHeuristic{
	...
	private double expansionPenaltyFactor = 0.1; //celoe 
//	private double expansionPenaltyFactor = 0.02; //ocel
	@ConfigOption(description = "bonus for being better than parent node", defaultValue = "0.3")
	private double gainBonusFactor = 0.3; //celoe
//	private double gainBonusFactor = 0.5; //ocel
