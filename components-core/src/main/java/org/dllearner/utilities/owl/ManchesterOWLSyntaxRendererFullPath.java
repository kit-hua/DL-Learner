 ...
 */
public class ManchesterOWLSyntaxRendererFullPath extends AbstractRenderer
implements OWLObjectVisitor {
	 ...
	 */
	public ManchesterOWLSyntaxRendererFullPath(Writer writer,
	...
	public void visit(OWLObjectProperty property) {
		...
		write("kb:" + getShortFormProvider().getShortForm(property));
	}
	...
	public void visit(OWLNamedIndividual individual) {
		...
		write("kb:" + getShortFormProvider().getShortForm(individual));
	}
...
//		write(getShortFormProvider().getShortForm(node));
		write("kb:" + getShortFormProvider().getShortForm(node));
	}

	@Override
	public void visit(@Nonnull OWLAnonymousIndividual individual) {
		write("kb:" + individual.toStringID());
	}
