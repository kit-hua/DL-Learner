...
@ComponentAnn(name="CELOE2", shortName="celoe2", version=1.0, description="CELOE is an adapted and extended version of the OCEL algorithm applied for the ontology engineering use case. See http://jens-lehmann.org/files/2011/celoe.pdf for reference.")
public class CELOE2 extends CELOE{

	private static final Logger logger = LoggerFactory.getLogger(org.dllearner.aml.CELOE2.class);
